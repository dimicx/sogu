...
import { BasicFadeInVanilla, CharacterRevealVanilla, LineByLineVanilla, MaskedLineRevealVanilla, AutoRevertVanilla, ResponsiveSplitVanilla, ScrollTriggeredVanilla, ScrollDrivenVanilla, WithGSAPVanilla, CSSOnlyVanilla } from "../../app/components/examples";
...
Use `IntersectionObserver` to detect when the element enters the viewport and trigger the animation. Set elements to invisible after splitting so they're hidden until the scroll trigger fires.
