...
import { BasicFadeIn, CharacterReveal, EmojiSupport, LineByLine, MaskedLineReveal, ResponsiveSplit, ScrollTriggered, ScrollDriven, AutoRevert } from "../../../app/components/examples";
...
Fetta correctly handles compound emojis like family groups, flags, and skin tone modifiers — each emoji is treated as a single character.
